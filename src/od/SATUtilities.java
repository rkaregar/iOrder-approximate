...
class ClauseDoubleVar {
    public int first, second;
    
    public ClauseDoubleVar(int first, int second) {
        this.first = first;
        this.second = second;
    }
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof ClauseDoubleVar)) return false;
        ClauseDoubleVar that = (ClauseDoubleVar) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(first ^ second);  // The order of literals does not matter
    }
}
